...
def generate_bill():
    ...
    quantity=quantityVar.get()
    cost = costVar.get()
    conn = pymysql.connect(host="localhost", user="root", passwd="", db="billserv")
    cursor = conn.cursor()
    
    query="insert into billing (name,quantity, rate, cost) values('{}','{}','{}','{}')".format(itemName,quantity,itemRate,cost)
...
def readAllData():
    ...
    options=[]
    rateDict={}
    conn = pymysql.connect(host="localhost", user="root", password="", db="billserv")
    cursor = conn.cursor(pymysql.cursors.DictCursor)
...
def loginWindow():
    titleLabel = Label(window,text="TV'S Billing System",font="Arial 40")
...
def mainwindow():
    ...
    titleLabel = Label(window,text="TV'S Billing System",font="Arial 30",fg="green")
    ...
    generateBill = Button(window, text="Generate bill", width =15,command=lambda:print_bill())
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="TV'S Billing System", width=40,font="Arial 30",fg="green")
