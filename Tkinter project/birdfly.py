...
def welcomeScreen():
    ...
    playerx = float(SCREENWIDTH/5)
    playery = float((SCREENHEIGHT - GAME_SPRITES['player'].get_height())/2)
    messagex = float((SCREENWIDTH - GAME_SPRITES['message'].get_width())/2)
    messagey = float(SCREENHEIGHT*0.13)
    basex = 0
    while True:
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers'] = ( 
        ...
        pygame.image.load('s6.png').convert_alpha(),
        pygame.image.load('s7.png').convert_alpha(),
        pygame.image.load('s8.png').convert_alpha(),
        pygame.image.load('s9.png').convert_alpha(),
    )
